...
while True:
    robot.setJPV(1, 0, 1)
    robot.setJPV(2, 0.3, 1)
    robot.setJPV(3, 0, 1)
    robot.setJPV(4, 0.3, 1)
    robot.setJPV(5, 0, 1)
    robot.setJPV(6, 0, 1)
    time.sleep(3)
    
    robot.setJPVs([-0.0993743801022351, 2.2795071335927375, 0.09746700236514805, 1.2998779278248271, -0.08449683375295614, 0.5930037384603644], [0.8]*6)
    # robot.setJPV(1, 0, 3)
    # robot.setJPV(2, 0, 3)
    # robot.setJPV(4, 0, 3)
    time.sleep(3)